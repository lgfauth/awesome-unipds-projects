...
- [lgfauth/truco-de-malandro](https://github.com/lgfauth/truco-de-malandro) `🐍` & `📇` `🏠` – Online Paulista Truco game against AI. You can play against the AI and watch the AI training in real time. [Live demo](https://truco-malandro.up.railway.app). **by [@lgfauth](https://github.com/lgfauth)**
